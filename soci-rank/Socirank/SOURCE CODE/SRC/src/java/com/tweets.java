...
public class tweets {
        ...
        List <String> tw1 = new LinkedList<String>();
        List <String> tw2 = new LinkedList<String>();
        List <String> tw3 = new LinkedList<String>();
       
	//	Set this to your actual CONSUMER KEY and SECRET for your application as given to you by dev.twitter.com
	private static final String CONSUMER_KEY		= "xVhKDw71OQ9Xfc9SJ4j99nMvH";
	private static final String CONSUMER_SECRET 	= "1uQV59R6VIraj6y1vFNwJYpruyWWnJyKaroQbPVx4SWHKqjmHh";
...
//									  cleanText(s.getText()));
                                        ...
                                        tw1.add(s.getCreatedAt().toString());
                                        tw2.add(s.getUser().getScreenName());
                                        tw3.add(cleanText(s.getText()).replace("'", ""));
