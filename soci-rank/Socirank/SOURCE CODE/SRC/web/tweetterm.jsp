...
<div class="scrollblock">
  <section style="background-color: skyblue;">
    <div class="container">
      <div class="row">
        <div class="span12">
            <center><h1 style="color:red;">Tweet Term Extraction</h1></center><br>
            ...
            <%
            PreparedStatement pso1 = con.prepareStatement("truncate table tweets");
            pso1.executeUpdate();
    int k=1;
            for(int i=0;i<a.size();i++)
            {
            PreparedStatement pso = con.prepareStatement("insert into tweets (content,tweets,tname,ttime) values ('"+content+"','"+c.get(i)+"','"+b.get(i)+"','"+a.get(i)+"') ");
            pso.executeUpdate();
            %>
           ...
           <tr style="color:#080606;font-weight: bold;">
            ...
            <ul id="menu-main" class="nav" style="width: 200px;">
                <li><a href="keyterm.jsp?content=<%=content%>">Stop Words Removal</a></li>
            </ul>
            </center>
            <br><br>
        </div>
