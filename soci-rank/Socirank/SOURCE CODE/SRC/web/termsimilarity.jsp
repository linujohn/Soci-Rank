...
<div class="scrollblock">
  <section style="background-color: skyblue;">
    <div class="container">
      <div class="row">
        <div class="span12">
            <center><h1 style="color:red;">Term Similarity (co-occur count, quotient of similarity) </h1></center><br>
            
           
            <center><h2 style="color:black;">Term Similarity For Tweets</h2></center><br>
            ...
            <tr align="center" style="font-weight: bold;font-size: 17px;">
                <th>Id</th>
                <th>Tweet</th>
                <th>Term Similarity</th>
           </tr>
           <%
           PreparedStatement psoo = con.prepareStatement("select * from tweets where content='"+content+"' and not termsimi='0' ");
           ...
           <tr style="color:#080606;font-weight: bold;">
                ...
                <td style="text-align: center;"><%=rsss.getString("termsimi")%></td>
            </tr>
            <%
           }
            %>
            ...
            <br>
            <center><h2 style="color:black;">Term Similarity For News</h2></center><br>
           ...
           <%
           PreparedStatement psoo1 = con.prepareStatement("select * from news where content='"+content+"' and not termsimi='0'  ");
           ...
           <tr style="color:#080606;font-weight: bold;">
                ...
                <td  style="text-align: center;"><%=rsss1.getString("termsimi")%></td>
            </tr>
            <%
           }
            %>
            ...
            <ul id="menu-main" class="nav" style="width: 250px;">
                <li><a href="outlier.jsp?content=<%=content%>">Outlier Detection</a></li>
            </ul>
            </center>
            <br><br>
        </div>
