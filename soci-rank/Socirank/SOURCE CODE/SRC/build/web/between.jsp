...
<div class="scrollblock">
  <section style="background-color: skyblue;">
    <div class="container">
      <div class="row">
        <div class="span12">
            <center><h1 style="color:red;">Betweenness Process</h1></center><br>
            
           
            <center><h2 style="color:black;">Betweenness For Tweets</h2></center><br>
           ...
           <%
           PreparedStatement psoo = con.prepareStatement("select * from tweets where content='"+content+"' and not betw='0' ORDER BY term DESC  ");
           ...
           <tr style="color:#080606;font-weight: bold;">
                ...
                <td style="text-align: center;"><%=rsss.getString("betw")%></td>
            </tr>
            <%
           }
            %>
            ...
            <br>
            <center><h2 style="color:black;">Betweenness For News</h2></center><br>
           ...
           <%
           PreparedStatement psoo1 = con.prepareStatement("select * from news where content='"+content+"' and not betw='0' ORDER BY term DESC  ");
           ...
           <tr style="color:#080606;font-weight: bold;">
                ...
                <td style="text-align: center;"><%=rsss1.getString("betw")%></td>
            </tr>
            <%
           }
            %>
            ...
            <ul id="menu-main" class="nav" style="width: 250px;">
                <li><a href="nodewei.jsp?content=<%=content%>">Node Weighting</a></li>
            </ul>
            </center>
            <br><br>
        </div>
