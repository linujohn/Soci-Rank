...
<div class="scrollblock">
  <section style="background-color: skyblue;">
    <div class="container">
      <div class="row">
        <div class="span12">
            <center><h1 style="color:red;">Relevant key term identification (n)</h1></center><br>
            
           
            <center><h2 style="color:black;">Relevant key term identification For Tweets</h2></center><br>
           ...
           <tr style="color:#080606;font-weight: bold;">
                ...
                <td style="text-align: center;"><%=rsss.getString("tf")%></td>
            </tr>
            <%
           }
            %>
            ...
            <br>
            <center><h2 style="color:black;">Relevant key term identification For News</h2></center><br>
           ...
           <tr style="color:#080606;font-weight: bold;">
                ...
                <td style="text-align: center;"><%=rsss1.getString("tf")%></td>
            </tr>
            <%
           }
            %>
            ...
            <ul id="menu-main" class="nav" style="width: 250px;">
                <li><a href="termsimilarity.jsp?content=<%=content%>">Term Similarity</a></li>
            </ul>
            </center>
            <br><br>
        </div>
