...
<div class="scrollblock">
  <section style="background-color: skyblue;">
    <div class="container">
      <div class="row">
        <div class="span12">
            <center><h1 style="color:red;">Outlier Detection Process</h1></center><br>
            
           
            <center><h2 style="color:black;">Outlier Detection For Tweets</h2></center><br>
           ...
           <%
           PreparedStatement psoo = con.prepareStatement("select * from tweets where content='"+content+"' and not outlierdet='0' ");
           ...
           <tr style="color:#080606;font-weight: bold;">
                ...
                <td style="text-align: center;"><%=rsss.getString("outlierdet")%></td>
            </tr>
            <%
           }
            %>
           ...
           <%
           PreparedStatement psoo1 = con.prepareStatement("select * from news where content='"+content+"' and not outlierdet='0'  ");
           ...
           <tr style="color:#080606;font-weight: bold;">
                ...
                <td style="text-align: center;"><%=rsss1.getString("outlierdet")%></td>
            </tr>
            <%
           }
            %>
            ...
            <ul id="menu-main" class="nav" style="width: 250px;">
                <li><a href="between.jsp?content=<%=content%>">Betweenness</a></li>
            </ul>
            </center>
            <br><br>
        </div>
